...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("e6d3b32a-0204-42cf-8491-6515bb7fdf80", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'Desktop'.", repo.Desktop.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.Desktop.Self, new Duration(0));
