...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("6c95d24d-92db-4107-b647-c5e8efb4d259", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'Web'.", repo.Web.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.Web.Self, new Duration(0));
